...
class ClientController(threading.Thread):
    ...
    def __init__(self,
        ...
        self.camera = picamera.PiCamera(resolution=(1280, 720), framerate=30)   # ************************ NC: Error with picamera ???? ********************************
        self.resolution = (1280, 720)
        # self.camera.zoom = (0.4, 0.35, 0.4, 0.3)
    ...
    def startPreviewing(self, previewPort: int, serverTime: float=0) -> None:
        ...
        if not self.previewing:
            ...
            # self.window.setText("previewing", "Yes")
    ...
    def saveCameraInfo(self) -> None:
        """ the cage ID and name, plus the camera view of the camera."""
    ...
    def setFPS(self, fps: int) -> None:  # ********************************** NC: error being thrown at exception where 'Unable to set frame rate of camera to {}" }}....
        ...
        """
        try:
            #self.camera.framerate = fractions.Fraction(fps)  # *************** NC: this doesn't work for some odd reason ****************************
